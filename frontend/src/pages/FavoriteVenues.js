...
export default () => {
    ...
    useEffect(() => {
        async function getSearchResults() {
            let response = await fetch('https://bookmyvenue.live:6969/venues/bookmarks/' + sessionStorage.getItem('user_name'), {
                method: 'GET'
            });
                                    ...
                                    >
                                        {results[tabKey].map((card, index) => (
                                            <CardContainer key={index}>
                                                <Card className="group" href="/venue" initial="rest"
                                                    ...
                                                    <CardImageContainer
                                                        ...
                                                        >
                                                            <CardButton
                                                                onClick={() => sessionStorage.setItem('venueId', card.id)}>Details</CardButton>
                                                        </CardHoverOverlay>
                                                    </CardImageContainer>
                                                    <CardText>
